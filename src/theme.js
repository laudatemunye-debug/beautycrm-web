...
export const DEVISES = [
  ...
  { code: 'XAF', symbol: 'FCFA', label: 'Franc CFA CEMAC (FCFA)' },
  { code: 'XOF', symbol: 'FCFA', label: 'Franc CFA UEMOA (FCFA)' },
  { code: 'DZD', symbol: 'DA',   label: 'Dinar algérien (DA)' },
  { code: 'AOA', symbol: 'Kz',   label: 'Kwanza angolais (Kz)' },
  { code: 'BWP', symbol: 'P',    label: 'Pula botswanaise (P)' },
  ...
  { code: 'MZN', symbol: 'MT',   label: 'Metical mozambicain (MT)' },
  { code: 'NAD', symbol: 'N$',   label: 'Dollar namibien (N$)' },
  { code: 'NGN', symbol: '₦',    label: 'Naira nigérian (₦)' },
  { code: 'RWF', symbol: 'RF',   label: 'Franc rwandais (RF)' },
  { code: 'TND', symbol: 'DT',   label: 'Dinar tunisien (DT)' },
  { code: 'TZS', symbol: 'TSh',  label: 'Shilling tanzanien (TSh)' },
  { code: 'UGX', symbol: 'USh',  label: 'Shilling ougandais (USh)' },
  { code: 'ZAR', symbol: 'R',    label: 'Rand sud-africain (R)' },
  { code: 'ZMW', symbol: 'ZK',   label: 'Kwacha zambien (ZK)' },
  { code: 'ZWG', symbol: 'ZWG',  label: 'Zimbabwe Gold (ZWG)' },
];
